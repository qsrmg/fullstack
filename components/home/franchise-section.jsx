      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-5 lg:grid-cols-3">
          {franchiseOptions.map((option) => (
            <article
              key={option.title}
              className="rounded-2xl border border-slate-200 bg-white p-6 shadow-soft transition hover:-translate-y-2 hover:shadow-card dark:border-slate-800 dark:bg-slate-900"
            >
              ...
              <button className="mt-6 w-full rounded-xl bg-gradient-to-r from-cyan-500 to-indigo-500 px-4 py-2.5 text-sm font-semibold text-white shadow-soft transition hover:shadow-card">
                Apply Now
              </button>
            </article>
          ))}
